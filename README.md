...
------------ | -------------
4 | 🤖 AI projects: ❗Saved 2000+ hours <br> 1) WFA eligibility check 2) Sending approvals 3) Sending reminders 4) Self-service global mobility   compensation estimator 5) Cleaning csv file 6) Word Macros to insert fields for transfer letters 7) Team dashboard 8) Relocation status report <br> ㊙️ Confidential cross-functional projects <br> 🆕 International mobility, immigration & tax <br>🆕 Co-led operations (team, vendor, project, program management) <br> 🥇 Equus Superuser (Admin certified) <br>💰 Budget and invoicing management <br> 🩺 Employee Benefits <br> 🐮 Attended Equus Annual Conference (Dallas) <br> 💻 Jira, Scribe, Ansana, Lucidchart, Microsoft Word Macros, Workato
3 | 🆕 US Immigration is now on the plate. <br> 🧰 Built a Location Tool for recruiters to determine Worday work locations based on cities. <br> 👾 Attended SHRM Session (Houston) <br> 💻 Microsoft Excel Marcos
